 ...
 */
@NonNullApi
public class LibrariesForProjectLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForProjectLibsInPluginsBlock(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
